...
# 📖 To Do List 02<a name="about-project"></a>

**To Do List 02** is a simple webpage that creates a todo list.
...
```sh
  cd my-folder
  git clone git@github.com:Al-Amin-Khan-Shakil/To-Do-List-02.git
```
...
- **Test Case For Update Functions**
...
Feel free to check the [issues page](https://github.com/Al-Amin-Khan-Shakil/To-Do-List-02/issues).
